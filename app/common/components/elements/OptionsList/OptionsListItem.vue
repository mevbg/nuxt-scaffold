...
.root {
  --list-item-bg-red: color-mix(
    in srgb,
    var(--ds-color-background-red-base) calc(var(--ds-opacity-10) * 100%),
    transparent calc(100% - calc(var(--ds-opacity-10) * 100%))
  );

  --list-item-bg-black: color-mix(
    in srgb,
    var(--ds-color-background-primary-inverted) calc(var(--ds-opacity-10) * 100%),
    transparent calc(100% - calc(var(--ds-opacity-10) * 100%))
  );
}
...
.root:focus-visible {
  outline: 1px solid var(--ds-color-primitive-red50);
  outline-offset: 0;
}
...
.disabled {
  ...
  svg {
    fill: var(--ds-color-content-primary-base);
  }
}
