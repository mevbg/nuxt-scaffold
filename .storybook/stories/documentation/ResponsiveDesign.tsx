      ...
      <div className="sb-unstyled">
        <ArticleWrapper title="Responsive Design">
          <p>
            ...
            of the user interface in the VARNAME.bg project. The approach combines{' '}
          ...
          <img src="/responsiveness.png" alt="VARNAME.bg Responsive Design" />
          ...
          <p>
            The VARNAME.bg layout is built upon a responsive{' '}
