  ...
  return (
    <React.Fragment>
      <TokensLayout
        ...
        description="This page outlines the border style tokens defined in the VARNAME Design System. These tokens govern the visual appearance of borders across UI elements, ensuring consistent visual hierarchy, focus, and separation in component interactions."
        tokens={tokens}
