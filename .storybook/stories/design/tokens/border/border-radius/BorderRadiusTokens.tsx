  ...
  return (
    <>
      <TokensLayout
        ...
        description="This page outlines the border radius tokens defined in the VARNAME Design System. These tokens govern the curvature of corners across UI elements, ensuring consistent visual hierarchy, focus, and separation in component interactions."
        tokens={tokens}
