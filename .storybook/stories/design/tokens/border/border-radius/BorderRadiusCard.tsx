    ...
    <React.Fragment>
      <style>{`
        .border-radius-card-${name} {
          ...
          border: var(--ds-border-width-base) var(--ds-border-style-solid) var(--ds-border-color-gray-weak) !important;
          border-radius: var(--ds-border-radius-${name});
        }
      `}</style>
      <TileCard
