  ...
  return (
    <React.Fragment>
      <TokensLayout
        ...
        description="This page outlines the border width tokens defined in the VARNAME Design System. These tokens control the thickness of borders applied across components, ensuring consistent visual weight, hierarchy, and structural clarity throughout the interface."
        tokens={tokens}
