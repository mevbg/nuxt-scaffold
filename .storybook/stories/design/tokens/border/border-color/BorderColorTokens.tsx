  ...
  return (
    <>
      <TokensLayout
        ...
        description="This page outlines the border color tokens defined in the VARNAME Design System. These tokens assign specific colors to border elements based on context — such as neutral dividers, interactive states, or validation feedback — ensuring visual clarity and consistency across components."
        tokens={tokens}
