  ...
  return (
    <>
      <TokensLayout
        ...
        description="This page outlines the letter spacing tokens defined in the VARNAME Design System. These tokens control the spacing between characters across different typographic styles, helping to optimize legibility, visual density, and the overall tone of textual elements."
        tokens={tokens}
