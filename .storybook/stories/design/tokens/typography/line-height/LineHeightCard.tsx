  ...
  return (
    <>
      <TileCard
        header={
          <TypoTokenBox
            text="VARNAME България организира ексклузивно, практическо обучение за брокери с фокус върху темата „Силата на етичната продажба“."
            style={{ lineHeight: `var(--ds-line-height-${name})` }}
          />
        }
        title={name}
        details={details}
