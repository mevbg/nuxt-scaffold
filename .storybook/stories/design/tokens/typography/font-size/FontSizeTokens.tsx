  ...
  return (
    <>
      <TokensLayout
        ...
        description="This page outlines the font size tokens defined in the VARNAME Design System. These tokens represent a consistent typographic scale used across headings, body text, captions, and UI elements — ensuring readability, visual hierarchy, and responsive behavior across all viewports."
        tokens={tokens}
