  ...
  return (
    <>
      <TokensLayout
        ...
        description="This page outlines the font weight tokens defined in the VARNAME Design System. These tokens control the available levels of typographic emphasis — ranging from light to bold — used consistently across text elements to convey hierarchy, structure, and tone."
        tokens={tokens}
