  ...
  return (
    <React.Fragment>
      <TokensLayout
        ...
        description="This page outlines the font family tokens defined in the VARNAME Design System. These tokens control the typographic foundation of the interface, specifying which font stacks are applied for primary content, alternative cases, or system fallbacks — ensuring consistency, readability, and cross-platform reliability."
        tokens={tokens}
