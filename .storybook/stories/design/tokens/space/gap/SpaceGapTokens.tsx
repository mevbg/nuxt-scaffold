  ...
  return (
    <React.Fragment>
      <TokensLayout
        ...
        description="This page outlines the gap tokens used in the VARNAME Design System. These tokens control the spacing between items within layout structures like stacks, grids, and flex containers — ensuring consistent alignment, rhythm, and responsiveness in component compositions."
        tokens={tokens}
