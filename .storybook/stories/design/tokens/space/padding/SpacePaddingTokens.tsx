  ...
  return (
    <>
      <TokensLayout
        ...
        description="This page outlines the padding space tokens used in the VARNAME Design System. These tokens control the internal spacing within components — ensuring consistent layout structure, breathing room, and alignment across various UI elements and screen sizes."
        tokens={tokens}
