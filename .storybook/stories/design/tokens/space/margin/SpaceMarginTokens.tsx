  ...
  return (
    <React.Fragment>
      <TokensLayout
        ...
        description="This page outlines the margin space tokens defined in the VARNAME Design System. These tokens govern the external spacing between elements, helping to maintain consistent layout rhythm, separation, and visual clarity throughout the interface."
        tokens={tokens}
