    ...
    <React.Fragment>
      <div className="sb-unstyled">
        <ArticleWrapper title="Contextual Color Tokens">
          <p>
            This page outlines the contextual color tokens defined in the VARNAME Design System.
        ...
        <style>{`
          .tabs-container {
            margin-block-start: var(--ds-size-500x600);
          }

          .tabs-nav {
            display: flex;
            border-bottom: 1px solid var(--ds-color-primitive-red50);
            margin-bottom: 3rem;
          }

          .tab-button {
            padding: 0.75rem var(--ds-size-150x200);
            border: none;
            ...
            font-size: 1.2rem;
            font-weight: 700;
            color: var(--ds-color-content-primary-base);
            border-bottom: 1px solid transparent;
          }

          .tab-button:hover {
            background-color: var(--ds-color-primitive-red90);
            color: var(--ds-color-primitive-black);
          }

          .tab-button.active {
            color: var(--ds-color-primitive-white);
            background-color: var(--ds-color-primitive-red50);
          }
        `}</style>
      </div>
    </React.Fragment>
