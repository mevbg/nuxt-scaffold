  ...
  return (
    <React.Fragment>
      <TokensLayout
        ...
        description="This page outlines the box shadow tokens defined in the VARNAME Design System. These tokens provide standardized shadow values that create depth, elevation, and visual separation between UI elements, helping users understand the interface hierarchy."
        tokens={tokens}
